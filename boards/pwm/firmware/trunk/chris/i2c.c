...
static void i2cw_servo_set( uint8_t *buf );	//to be written

/* Transmit (read) functions */
static uint8_t i2cr_identity( uint8_t *buf );

/* Send the motor 0 setting to the master */
static uint8_t i2cr_servo_get( uint8_t *buf ); 	//to be written
...
static void i2cw_servo_set( uint8_t *buf )	//to be changed
{
	//rewrite
}
...
static uint8_t i2cr_servo_get( uint8_t *buf)	//to be changed
{
	//rewrite
