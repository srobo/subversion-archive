...
#if defined(MSD_OUT_EP_SIZE)
    #if (MSD_OUT_EP_SIZE > 64)
        #error(MSD Out endpoint size cannot be bigger than 64, check "autofiles\usbcfg.h")
    #endif
#endif

#if defined (MSD_IN_EP_SIZE)
    #if (MSD_IN_EP_SIZE > 64)
        #error(MSD In endpoint size cannot be bigger than 64, check "autofiles\usbcfg.h")
    #endif
#endif
