window.addEvent('domready', function() {	//var mylogingif = new Asset.image('srobo-login.gif', {id: 'login-img', title: 'ALoginGif'});
	...
	var scene1 = function(){ 
			...
			top.set('html', '<img src=\'file:///home/chris/srobo/ide2/ajax/images/srobo-login.gif\' /> Logging you in...');
