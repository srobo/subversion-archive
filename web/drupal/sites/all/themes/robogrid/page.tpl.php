    ...
    <div id="top">
        ...
        <div id="header">
            ...
            <form id="login" action="" method="post">
                <p>
		<label for="login_user">SR Username</label>
		<input type="text" value="Username" name="user" id="login_user" class="login" onfocus="this.value='';" />
		<label for="login_pass">SR Password</label>
		<input type="password" value="Password" name="pass" id="login_pass" class="login" onfocus="this.value='';" />
